...
POS = {
    ...
    "SFTF_Clustering": (419, -310),
    "PFTF": (507, 422),
    "SFTF_Composite": (607, 732),
    "SFTF_InjMold": (-267, -85),
    "PFTF_Compression": (426, 681),
    "Tomo_DFSVR": (39, -37),
    "PFTF_VisCull_kDop": (107, 447),
    "SFTF_SewerPOC": (-192, -299),
    "SFTFSoft_GNN": (160, 85),
    "SFTF_DrapePrior": (168, 685),
    "PFTF_AsymTensor": (317, 255),
    "PFTF_DrapePrior_VisCull_kDop": (-260, 448),
    "PFTF_ResearchOptimize": (714, 478),
    "PFTF_GFiberCT": (280, 586),
    "SFTF_QEM": (519, 90),
    "SFTF_DynamicTargetSearch": (697, -261),
    "DFSVR_VisCull": (-180, 212),
    "SFTFSoft_GNN_DFSVR": (-90, 313),
    "SFTF_ActiveOverprint": (498, -475),
    "ColdOndol": (189, -318),
    "ColdOndol_Positioning": (29, -557),
    "cfmsCIPC": (153, 940),
    ...
    "cfmsDrape": (-262, 782),
    "cfmsMiindo": (57, 779),
    "cfmsPINNCAD": (328, 1186),
    "SFTFSoft_DFSVR": (173, -153),
    # Restored from the last pre-archive graph snapshot.
    "SFTF_UrbanTraffic": (-60, -168),
    "cfmsAutoSew": (128, 1429),
    "cfmsAutoPlace_IJCST": (-28, 1128),
    "cfmsAutoPlace_JCDE": (-190, 1136),
    # 2026-09-01: ToDo DrapeSCAN onboarding from the Obsidian project note.
    "cfmsDrapeSCAN": (427, 932),
