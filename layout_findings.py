...
QUALITY_ROWS = [
    ...
    ("PFTF_GFiberCT", "PFTF_GFiberCT", "중", "합성 144건·NCF 유리섬유 복합재 X선 CT 17쌍(원저자 분할) 사전등록 검증, B5/M1 대비 사례별 144/144·17/17 승, 위상 오차 0; **2026-09-22 한국복합재료학회지 투고 완료**(은종현 교수 측 투고, 저자 박명진·은종현*·설인환*). ⏳ 원고번호 미확인. PFTF/local-SPD 우월성 제외"),
