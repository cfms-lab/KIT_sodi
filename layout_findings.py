...
POS = {
    ...
    "PFTF_AsymTensor": (185, 224),
    "PFTF_DrapePrior_VisCull_kDop": (579, 152),
    "PFTF_ResearchOptimize": (4, 408),
    "PFTF_alpha": (179, 1080),
    "SFTF_QEM": (-57, 76),
    "SFTF_DynamicTargetSearch": (-187, 12),
    "DFSVR_VisCull": (523, -13),
    "SFTFSoft_GNN_DFSVR": (331, -132),
    "SFTF_ActiveOverprint": (-11, -134),
    "ColdOndol": (-235, 478),
    "ColdOndol_Positioning": (-417, 589),
    "cfmsCIPC": (556, 601),
    "TSE_SEM": (19, 771),
    "SFTF_HeatMethod": (268, 951),
    "cfmsPINNDrape": (724, 246),
    "cfmsDrape": (568, 431),
    "cfmsMiindo": (997, 740),
    "cfmsPINNCAD": (775, 403),
    "SFTFSoft_DFSVR": (339, 197),
    # Restored from the last pre-archive graph snapshot.
    "SFTF_UrbanTraffic": (-88, 665),
    "cfmsAutoSew": (937, 358),
    "cfmsAutoPlace_IJCST": (799, 522),
    "cfmsAutoPlace_JCDE": (821, 776),
