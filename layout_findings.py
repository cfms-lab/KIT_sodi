...
POS = {
    ...
    "Tomo_SFTF": (9, -28),
    "Tomo_SFTFSoft": (-208, 185),
    "SFTF_Clustering": (-450, 258),
    "PFTF": (282, 170),
    "SFTF_Composite": (592, 70),
    "SFTF_InjMold": (-225, 944),
    "PFTF_Compression": (541, 251),
    "Tomo_DFSVR": (-193, 552),
    "PFTF_VisCull_kDop": (307, 543),
    "SFTF_SewerPOC": (-439, 869),
    "SFTFSoft_GNN": (-55, 517),
    "SFTF_DrapePrior": (545, 509),
    "PFTF_AsymTensor": (115, 360),
    "PFTF_DrapePrior_VisCull_kDop": (308, 937),
    "PFTF_ResearchOptimize": (338, -37),
    "PFTF_GFiberCT": (446, 397),
    "SFTF_QEM": (-50, 158),
    "SFTF_DynamicTargetSearch": (-401, -20),
    "DFSVR_VisCull": (-31, 808),
    "SFTFSoft_GNN_DFSVR": (133, 721),
    "SFTF_ActiveOverprint": (-615, 179),
    "ColdOndol": (-458, 488),
    "ColdOndol_Positioning": (-697, 648),
    "cfmsCIPC": (800, 524),
...
(function () {
  ...
  if (resetBtn) resetBtn.addEventListener('click', () => {
    setTimeout(() => { if (applyShared(true)) network.redraw(); }, 0);
  });
  load();
})();
