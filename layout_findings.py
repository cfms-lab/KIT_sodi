...
POS = {
    ...
    "SFTFSoft_GNN": (131, 72),
    "SFTF_DrapePrior": (277, 280),
    "PFTF_AsymTensor": (208, 160),
    "PFTF_DrapePrior_VisCull_kDop": (352, 374),
    "PFTF_ResearchOptimize": (-8, 373),
    "PFTF_alpha": (91, 263),
    "SFTF_QEM": (23, 174),
    "SFTF_DynamicTargetSearch": (-122, -18),
    "DFSVR_VisCull": (424, 99),
    "SFTFSoft_GNN_DFSVR": (248, -68),
    "SFTF_ActiveOverprint": (-26, 91),
    "ColdOndol": (-203, 466),
    "ColdOndol_Positioning": (-305, 368),
    "cfmsCIPC": (511, 332),
    "TSE_SEM": (147, 647),
