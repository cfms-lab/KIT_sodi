...
POS = {
    ...
    "Tomo_SFTF": (-323, 234),
    "Tomo_SFTFSoft": (-74, 240),
    "SFTF_Clustering": (-117, 493),
    "PFTF": (20, 453),
    "SFTF_Composite": (298, 752),
    "SFTF_InjMold": (-92, 861),
    "PFTF_Compression": (452, 819),
    "Tomo_DFSVR": (313, 172),
    "PFTF_VisCull_kDop": (363, 565),
    "SFTF_SewerPOC": (-281, 810),
    "SFTFSoft_GNN": (86, -25),
    "SFTF_DrapePrior": (347, 333),
    "PFTF_AsymTensor": (181, 66),
    "PFTF_DrapePrior_VisCull_kDop": (572, 287),
    "PFTF_ResearchOptimize": (243, 402),
    "PFTF_alpha": (126, 1103),
    "SFTF_QEM": (-97, 81),
    "SFTF_DynamicTargetSearch": (-229, -34),
    "DFSVR_VisCull": (524, 176),
    "SFTFSoft_GNN_DFSVR": (342, -156),
    "SFTF_ActiveOverprint": (28, -179),
    "ColdOndol": (-271, 479),
    "ColdOndol_Positioning": (-417, 589),
    "cfmsCIPC": (729, 229),
    "TSE_SEM": (11, 887),
    "SFTF_HeatMethod": (256, 905),
    "cfmsPINNDrape": (965, 305),
    "cfmsDrape": (568, 431),
    "cfmsMiindo": (485, 662),
    "cfmsPINNCAD": (745, 415),
    "SFTFSoft_DFSVR": (239, 295),
    # Restored from the last pre-archive graph snapshot.
    "SFTF_UrbanTraffic": (-74, 637),
    "cfmsAutoSew": (681, 705),
    "cfmsAutoPlace_IJCST": (934, 751),
    "cfmsAutoPlace_JCDE": (605, 843),
    # 2026-09-01: ToDo DrapeSCAN onboarding from the Obsidian project note.
    "cfmsDrapeSCAN": (1021, 588),
