...
POS = {
    ...
    "SFTF_Clustering": (-5, 498),
    "PFTF": (141, 423),
    "SFTF_Composite": (254, 798),
    "SFTF_InjMold": (-92, 861),
    "PFTF_Compression": (395, 772),
    "Tomo_DFSVR": (272, 54),
    "PFTF_VisCull_kDop": (363, 565),
    "SFTF_SewerPOC": (-281, 810),
    "SFTFSoft_GNN": (121, -5),
    "SFTF_DrapePrior": (347, 333),
    "PFTF_AsymTensor": (192, 210),
    "PFTF_DrapePrior_VisCull_kDop": (580, 176),
    "PFTF_ResearchOptimize": (4, 408),
    "PFTF_alpha": (179, 1080),
    "SFTF_QEM": (-96, 99),
    "SFTF_DynamicTargetSearch": (-229, -34),
    "DFSVR_VisCull": (572, -48),
    "SFTFSoft_GNN_DFSVR": (386, -133),
    "SFTF_ActiveOverprint": (-3, -158),
    "ColdOndol": (-235, 478),
    "ColdOndol_Positioning": (-417, 589),
    "cfmsCIPC": (556, 601),
    "TSE_SEM": (19, 771),
    "SFTF_HeatMethod": (268, 951),
    "cfmsPINNDrape": (728, 241),
    "cfmsDrape": (568, 431),
    "cfmsMiindo": (997, 740),
    "cfmsPINNCAD": (775, 403),
    "SFTFSoft_DFSVR": (381, 206),
    # Restored from the last pre-archive graph snapshot.
    "SFTF_UrbanTraffic": (-88, 665),
    "cfmsAutoSew": (1002, 386),
    "cfmsAutoPlace_IJCST": (838, 503),
    "cfmsAutoPlace_JCDE": (783, 762),
    # 2026-09-01: ToDo DrapeSCAN onboarding from the Obsidian project note.
    "cfmsDrapeSCAN": (627, 884),
    # 2026-09-07: graph.html 의 큐레이션 노드(SFTF_HOLONOMY_NODE)와 짝을 이룬다.
    "SFTF_Holonomy": (47, 965),
}
