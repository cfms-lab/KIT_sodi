...
QUALITY_ROWS = [
    ...
    ("PFTF_GFiberCT", "PFTF_GFiberCT", "하", "합성 144건·NCF 유리섬유 복합재 X선 CT 17쌍(원저자 분할) 사전등록 검증, B5/M1 대비 사례별 144/144·17/17 승, 위상 오차 0; **2026-09-22 한국복합재료학회지 투고 완료**(은종현 교수 측 투고, 저자 박명진·은종현*·설인환*). ⏳ 원고번호 미확인. PFTF/local-SPD 우월성 제외"),
    ...
    ("TSE_SEM1_Bezier", "TSE_SEM1_Bezier", "하",
     "① 방향 리프팅+3차 Bézier 관 재구성; 실제 SEM IoU 0.814·팬텀 12종 배향 오차 2.3–11.6°, **2026-09-22 한국복합재료학회지 투고 완료**(은종현 교수 측 투고). ⏳ 원고번호 미확인 — ②Tensor 가 이 번호로 companion 인용을 확정한다"),
    ("TSE_SEM2_Tensor", "TSE_SEM2_Tensor", "하",
     "② 이진화 없는 배향 텐서장, 하부층 포함; 저배율 SEM 9장 observed fraction 0.86–0.93, 원고 완성. ① 이 2026-09-22 에 나갔으므로 그 접수번호를 받아 companion 인용을 확정한 뒤 같은 **한국복합재료학회지**에 은종현 교수 측이 투고한다"),
...
if preserve_extended_quality:
    s = _update_json_object_constant(
        ...
        "STATUS_BADGES",
        {
            ...
            "PFTF_GFiberCT": "한국복합재료학회지 투고 완료 (2026-09-22, 은종현 교수 측 투고 · 원고번호 미확인)",
            ...
            "TSE_SEM1_Bezier": "한국복합재료학회지 투고 완료 (2026-09-22, 은종현 교수 측 투고 · 원고번호 미확인)",
