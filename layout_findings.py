...
POS = {
    ...
    "SFTF_Clustering": (29, 498),
    "PFTF": (141, 423),
    "SFTF_Composite": (323, 728),
    "SFTF_InjMold": (-16, 805),
    "PFTF_Compression": (424, 793),
    "Tomo_DFSVR": (287, 35),
    ...
    "PFTF_DrapePrior_VisCull_kDop": (516, 262),
    ...
    "cfmsCIPC": (516, 669),
    "TSE_SEM": (182, 712),
    "SFTF_HeatMethod": (225, 818),
    "cfmsPINNDrape": (652, 239),
    "cfmsDrape": (586, 513),
    "cfmsMiindo": (797, 682),
    "cfmsPINNCAD": (727, 395),
    "SFTFSoft_DFSVR": (365, 164),
    # Restored from the last pre-archive graph snapshot.
    "SFTF_UrbanTraffic": (-32, 616),
    "cfmsAutoSew": (848, 372),
    "cfmsAutoPlace_IJCST": (797, 525),
