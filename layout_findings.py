...
POS = {
    ...
    "PFTF": (141, 423),
    "SFTF_Composite": (328, 762),
    "SFTF_InjMold": (-16, 805),
    "PFTF_Compression": (452, 819),
    "Tomo_DFSVR": (250, 253),
    "PFTF_VisCull_kDop": (363, 535),
    "SFTF_SewerPOC": (-165, 739),
    "SFTFSoft_GNN": (63, 52),
    "SFTF_DrapePrior": (355, 349),
    "PFTF_AsymTensor": (182, 106),
    "PFTF_DrapePrior_VisCull_kDop": (476, 249),
    "PFTF_ResearchOptimize": (4, 408),
    "PFTF_alpha": (142, 1024),
    "SFTF_QEM": (-64, 96),
    "SFTF_DynamicTargetSearch": (-187, 12),
    "DFSVR_VisCull": (449, 36),
    "SFTFSoft_GNN_DFSVR": (322, -72),
    "SFTF_ActiveOverprint": (1, -111),
    "ColdOndol": (-205, 434),
    "ColdOndol_Positioning": (-323, 497),
    "cfmsCIPC": (493, 649),
    "TSE_SEM": (182, 712),
    "SFTF_HeatMethod": (241, 848),
    "cfmsPINNDrape": (671, 339),
    "cfmsDrape": (586, 513),
    "cfmsMiindo": (590, 750),
    "cfmsPINNCAD": (676, 449),
    "SFTFSoft_DFSVR": (459, 172),
    # Restored from the last pre-archive graph snapshot.
    "SFTF_UrbanTraffic": (-3, 631),
    "cfmsAutoSew": (843, 596),
    "cfmsAutoPlace_IJCST": (865, 690),
    "cfmsAutoPlace_JCDE": (736, 792),
    # 2026-09-01: ToDo DrapeSCAN onboarding from the Obsidian project note.
    "cfmsDrapeSCAN": (753, 542),
    # 2026-09-07: graph.html 의 큐레이션 노드(SFTF_HOLONOMY_NODE)와 짝을 이룬다.
    "SFTF_Holonomy": (186, 940),
}
